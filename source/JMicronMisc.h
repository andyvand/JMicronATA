...
#ifndef _JMICRON_MISC_H_
#define _JMICRON_MISC_H_
...
/*
 * JMicron specific property keys for ATADeviceNub
 */
#define kJMicronDeviceType				"jmicron device type"
#define kJMicronIDEDevice				"jmb-ide"

//#define DEBUG							1

#ifdef  DEBUG
#define DbgPrint(fmt, args...) IOLog("[JMicronATA] " fmt, ## args)
#define ErrPrint(fmt, args...) IOLog("[JMicronATA] " fmt, ## args)
#else
